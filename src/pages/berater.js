            ...
            <Row className="margin-p-40">
              <Col md={12}>
                <div className="box ">
                  ...
                  <div className="text">
                    <p>
                      {graphData.allContentfulConsultant.edges[0].node.businessDevelopment.businessDevelopment}
                    </p>
                  </div>
                </div>
              </Col>
            ...
            <Row className="margin-p-40">
              <Col md={12}>
                <div className="box">
                  ...
                  <div className="text">
                    <p>
                      {graphData.allContentfulConsultant.edges[0].node.existenzgrndungsberatung.existenzgrndungsberatung}
                    </p>
                  </div>
                </div>
              </Col>
